...
Para apagar en VIEW, presiona y mantén presionado el botón de encendido `(#1)` durante 2 segundos. Aparecerá un aviso de confirmación en la pantalla. Gira la perilla y selecciona “Sí” y presiona la perilla en el botón de aceptar `(#5)` para apgar.
